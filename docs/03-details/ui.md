...
ai_summary: "WebSSHの画面一覧（接続画面・ターミナル画面）・画面遷移・UI要素・レスポンシブ対応を定義"
---
...
本ドキュメントは、WebSSHのUI設計を定義する。確定デザイン（ssh_connect_2_2, terminal_sc_2_1, mobile_term_2_1）に基づく。
...
| アクセス権 | Basic認証済みユーザー |
| 参照デザイン | `webssh___ssh_connect_2_2.html` |

#### 構成要素

| 要素 | 種別 | 説明 |
|------|------|------|
| ターミナルヘッダー | 装飾 | ウィンドウコントロール風ドット3つ + タイトル「webssh -- connect」 |
...
| 参照デザイン | `webssh___terminal_sc_2_1.html`, `webssh___mobile_term_2_1.html` |
